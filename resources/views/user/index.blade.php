...
@section('body')
    ...
    @if(count($errors))
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <span class="fe fe-x-circle fe-16 mr-2"></span> Data user gagal dihapus!
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3">
                            <label for="plan_id">Plan Sekarang</label>
                        ...
                        <button class="btn btn-primary" type="button" onclick="filterUser('CARI')">CARI</button>
                        <button class="btn btn-danger" type="button" onclick="filterUser('RESET')">RESET</button>
                    </div>
                </div>
            </div>
        </div>

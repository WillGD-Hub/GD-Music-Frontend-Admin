...
@section('body')
    ...
    @if(count($errors))
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <span class="fe fe-x-circle fe-16 mr-2"></span> Data crawl gagal ditambahkan!
    ...
    <br>
    <h2 class="page-title">Insert Crawl</h2>
    <p class="text-muted">Halaman untuk menambah crawl baru.</p>

    {{-- START FORM --}}

    <form action="{{url('/crawl/insert')}}" method="post">
        @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3">
                            ...
                            id="name" type="text" name="name" placeholder="Nama Website" value="{{old('name')}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            id="url" type="text" name="url" placeholder="URL Website" value="{{old('url')}}">
                            <div class="valid-feedback"> Sudah benar! </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            id="max_depth" type="text" name="max_depth" placeholder="Max Depth" value="{{old('max_depth')}}">
                            <div class="valid-feedback"> Sudah benar! </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" id="regex" name="regex" rows="5" @if (count($errors)) @error('regex') is-invalid @else is-valid @enderror @endif></textarea>
                            <div class="valid-feedback"> Sudah benar! </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            id="tag_stop" type="text" name="tag_stop" placeholder="tag.class|inside/next|number" value="{{old('tag_stop')}}">
                            <div class="valid-feedback"> Sudah benar! </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            id="tag_title" type="text" name="tag_title" placeholder="tag.class|inside/next|number" value="{{old('tag_title')}}">
                            <div class="valid-feedback"> Sudah benar! </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            id="tag_lyrics" type="text" name="tag_lyrics" placeholder="tag.class|inside/next|number" value="{{old('tag_lyrics')}}">
                            <div class="valid-feedback"> Sudah benar! </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" id="correction" name="correction" rows="5" @if (count($errors)) @error('correction') is-invalid @else is-valid @enderror @endif></textarea>
                            <div class="valid-feedback"> Sudah benar! </div>

...
@section('body')
    ...
    @if(count($errors))
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <span class="fe fe-x-circle fe-16 mr-2"></span> Data plan gagal ditambahkan!
    ...
    <br>
    <h2 class="page-title">Insert Plan</h2>
    <p class="text-muted">Halaman untuk menambah plan baru.</p>

    {{-- START FORM --}}

    <form action="{{url('/plan/insert')}}" method="post" enctype="multipart/form-data">
        @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3">
                            ...
                            id="name" type="text" name="name" placeholder="Nama Plan" value="{{old('name')}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                id="price" type="text" name="price" placeholder="Harga Plan" value="{{old('price')}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                id="validation" type="text" name="validation" placeholder="Validation Plan" value="{{old('validation')}}">
                                <div class="input-group-append">

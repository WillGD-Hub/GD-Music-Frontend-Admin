...
@section('body')
    ...
    @if(count($errors))
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <span class="fe fe-x-circle fe-16 mr-2"></span> Data genre gagal dihapus!
    ...
    <h2 class="page-title">List Genre</h2>
    <p class="text-muted">Halaman untuk melihat genre.</p>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" id="genre_id" type="text" name="genre_id" placeholder="Genre ID">
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <label for="img">Image Genre</label>
                        ...
                        <button class="btn btn-primary" type="button" onclick="filterGenre('CARI')">CARI</button>
                        <button class="btn btn-danger" type="button" onclick="filterGenre('RESET')">RESET</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row my-4">
        <div class="col-md-12">
            <div class="card shadow">
                <div class="card-body">
                    <a class="float-right" href="{{url('/genre/insert')}}">
                        <button type="button" class="btn mb-2 btn-primary">Tambah Genre</button>
                    </a>
                    <br><br><br>
